    ...
    if (wallets && wallets[0]) {
      ...
      try {
        const transferTransaction =
          await getTransferTransaction(transferParams);
      ...
      <div className={styles.sendBodyContainer}>
        ...
        <div className={styles.sendDetailsContainer}>
          <div className={styles.keyValueContainer}>
            <div className={styles.keyContainer}>From</div>
            <div className={styles.valueContainer}>
              {wallets && wallets[0] ? trimAddress(wallets[0].address) : ""}
            </div>
          </div>
          <div className={styles.keyValueContainer}>
            <div className={styles.keyContainer}>To</div>
            <div className={styles.valueContainer}>
              {recipient ? trimAddress(recipient) : ""}
            </div>
          </div>
          <div className={styles.keyValueContainer}>
            <div className={styles.keyContainer}>Token</div>
            <div className={styles.valueContainer}>
              {token ? token.name : ``}
            </div>
          </div>
          <div className={styles.keyValueContainer}>
            <div className={styles.keyContainer}>Amount</div>
            <div className={styles.valueContainer}>{amount}</div>
          </div>
        </div>
        <div
